...
namespace eval :: {
   ...
   set ::sa::_netlistFlow 0
    ...
    set ::sa::_simServer::_simServerId stb.gmid.gmid_nfet_3v3.schematic.session4
    ::sa::_simServer::_setInfoByKeyInSimServerShell GUI_PID 3878190
    db::setPrefValue saPrintLoadingStartupFilesErrors -value false
    sa::_simServer::runSimulationInServer /home/argershm/180-voltmeter/Analog/cc/synopsys_custom/sim_server/custom_compiler.argershm/stb.gmid.gmid_nfet_3v3.schematic.session4
}
