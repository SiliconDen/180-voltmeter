...
namespace eval :: {
   ...
   set ::sa::_netlistFlow 0
    ...
    set ::sa::_simServer::_simServerId stb.integrator.tb_main_opamp.schematic.session0
    ::sa::_simServer::_setInfoByKeyInSimServerShell GUI_PID 3456063
    set ::env(DISPLAY) claws-compute3.ece.ncsu.edu:107
    set ::env(SYNOPSYS_CUSTOM_SERVER_CC) claws-compute3.ece.ncsu.edu:40399
    db::setPrefValue saPrintLoadingStartupFilesErrors -value false
    db::setPrefValue saPrintBgNetlistingMessages -value false
    sa::_simServer::runSimulationInServer /home/argershm/180-voltmeter/Analog/cc/synopsys_custom/sim_server/custom_compiler.argershm/stb.integrator.tb_main_opamp.schematic.session0
}
